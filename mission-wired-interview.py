...
constituents = pd.read_csv('https://als-hiring.s3.amazonaws.com/fake_data/2020-07-01_17%3A11%3A00/cons.csv',usecols = ['cons_id','create_dt','modified_dt'])
...
# final_res.drop('cons_email_id', inplace=True, axis=1)
# final_res.drop('cons_id', inplace=True, axis=1)
...
final_res_filtered = final_res_filtered[['email', 'is_unsub', 'create_dt','modified_dt']]
